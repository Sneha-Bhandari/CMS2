...
import EditChefs from "./EditChefs";
import DeleteChefs from "./DeleteChefs";

function GetChefs() {
  const [edit, setEdit] = useState(false);
  const [deletes, setDeletes] = useState(null);

  const header = [ "Image","Name","Post", "Action"];
  ...
  return (
    <div className="w-full h-fit  flex ">
      ...
      {deletes && (
        <div>
          <DeleteChefs setDeletes={setDeletes} />
        </div>
      )}
        ...
        <table className="w-full h-full text-center ">
          ...
          <tbody className="text-gray-900 text-sm text-center">
            <tr className="border border-gray-300 hover:bg-gray-100 transition">
              ...
              <td className="px-4 py-3 border border-gray-300">Sneha Bhandari</td>
              <td className="px-4 py-3 border border-gray-300">CEO</td>
